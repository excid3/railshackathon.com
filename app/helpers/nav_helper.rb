module NavHelper
  # Passing `starts_with: '/apps'` will match all urls starting with /apps
  # Passing `starts_with: true` will use the link's path for matching
  def nav_link_to(name = nil, options = {}, html_options = {}, &block)
    ...
    starts_with = url if starts_with == true
